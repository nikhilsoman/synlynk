...
| **v0.21.0** | 2026-09-25 | **The Autonomous Onboarding & Fleet Swarm Release:** First-Time User Experience (FTUE) Onboarding Journey (Quick Install, 3D Discovery, Context Validation, Unified 3-View Vizor Canvas, Gap & Opportunity Engine -> GOVERNS Goals in `state.db`, First-Win Task SOP Dispatch), Ephemeral cloud swarm runners (#1341), prompt cache telemetry true-up, automatic mid-session context compaction. | In Progress |
