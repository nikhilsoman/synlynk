...
- [ ] BS-14: brainstorm — Harness Compatibility: headless execution contracts, per-agent dispatch flag maps, compliance test suite, STALL_NO_OUTPUT sentinel spec <!-- id:story-6e4ba797 --> <!-- gh:#81 --> <!-- priority:next -->
