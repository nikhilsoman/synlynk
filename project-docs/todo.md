...
- [ ] v0.10.0 (P0): README overhaul — install one-liner, 60-second quickstart, command reference table, agent dispatch examples, badge strip (tests passing, version, license) [docs] <!-- id:story-v010-readme -->
