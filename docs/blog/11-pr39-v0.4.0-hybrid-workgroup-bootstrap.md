...
<figure class="brainstorm-visual">
  <iframe src="/assets/brainstorm/hybrid-workgroup-imperatives/dispatch-evolution.html" title="Dispatch model from the design session" loading="lazy" frameborder="0"></iframe>
  <figcaption>Dispatch model from the design session</figcaption>
</figure>

<figure class="brainstorm-visual">
  <iframe src="/assets/brainstorm/v041-architecture/design-architecture.html" title="v0.4.1 architecture diagram" loading="lazy" frameborder="0"></iframe>
  <figcaption>v0.4.1 architecture diagram</figcaption>
</figure>
