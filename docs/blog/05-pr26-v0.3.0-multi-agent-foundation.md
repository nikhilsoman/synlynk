...
<figure class="brainstorm-visual">
  <iframe src="/assets/brainstorm/multi-agent-foundation/multi-agent-foundation-pivot.html" title="The v0.3.0 Pivot: Solo Tool → Workgroup OS" loading="lazy" frameborder="0"></iframe>
  <figcaption>The v0.3.0 Pivot: Solo Tool → Workgroup OS</figcaption>
</figure>
