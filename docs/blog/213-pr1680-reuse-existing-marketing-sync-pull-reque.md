---
title: "PR #1680 — reuse existing marketing sync pull request"
date: 2026-09-18
...
Focused, limited-treatment delta resolving PR #1680 requirements with strict backward compatibility and comprehensive verification.

## What This PR Shipped

- Merged improvements and fixes for PR #1680.

## Verification & Test Evidence

Verified via local regression test suite and GitHub Actions CI matrix.
