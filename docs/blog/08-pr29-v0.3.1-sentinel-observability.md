...
<figure class="brainstorm-visual">
  <iframe src="/assets/brainstorm/sentinel-observability/sentinel-observability-system.html" title="v0.3.1 — The 9-Signal Self-Diagnostic Layer" loading="lazy" frameborder="0"></iframe>
  <figcaption>v0.3.1 — The 9-Signal Self-Diagnostic Layer</figcaption>
</figure>
