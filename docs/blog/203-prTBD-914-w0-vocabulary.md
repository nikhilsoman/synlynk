...
**Shift in this PR:** #914 is foundational for Teams, multi-repo products, and member-dispatch, but it is not one ticket. This PR does **not** implement Apps, Vizor hosting, or the `state.db` move. It records **W0–W3, W5, W6, W8, W9**.

**What shipped:** W0–W2 graph/identity; W3 Vizor Board + export protocol; W5 types; W6 policy; W8 packs; W9 hosted Vizor plan (`synlynk.com/<slug>`, entire surface, GitHub OAuth). No code.
...
**New goalpost:** Review W0–W3, W5, W6, W8, W9 on PR #1647. Remaining: **W4** members, **W7** runtime. Writing-plans / code wait for an explicit go. #914 stays OPEN.
