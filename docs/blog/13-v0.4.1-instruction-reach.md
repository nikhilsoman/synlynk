...
<figure class="brainstorm-visual">
  <iframe src="/assets/brainstorm/instruction-reach/instruction-reach-ecosystem.html" title="Instruction Reach — 7 IDE/Agent Targets" loading="lazy" frameborder="0"></iframe>
  <figcaption>Instruction Reach — 7 IDE/Agent Targets</figcaption>
</figure>
