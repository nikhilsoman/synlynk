...
<figure class="brainstorm-visual">
  <iframe src="/assets/brainstorm/v020-kernel/v020-kernel-architecture.html" title="v0.2.0 — The Kernel Components" loading="lazy" frameborder="0"></iframe>
  <figcaption>v0.2.0 — The Kernel Components</figcaption>
</figure>
