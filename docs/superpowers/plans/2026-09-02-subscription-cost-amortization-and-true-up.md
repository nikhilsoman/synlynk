...
- [x] **Task 1: Extend Harness Billing Configuration Schema**
...
- [x] **Task 2: Implement Dynamic Subscription Amortization & Overage in `synlynk/costs.py`**
...
- [x] **Task 3: Implement True-Up Reconciler CLI (`synlynk cost true-up`)**
...
- [x] **Task 4: Update Documentation, Devlog, and Memory**
