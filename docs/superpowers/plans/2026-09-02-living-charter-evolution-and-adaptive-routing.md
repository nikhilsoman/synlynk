...
- [x] **Task 1: Bayesian Capability Calibrator & Ledger (`synlynk/capability.py`)**
...
- [x] **Task 2: Adaptive Expected-Value Dispatch Router**
...
- [x] **Task 3: Living Charter PR Proposal Generator (`synlynk charters adapt`)**
...
- [ ] **Task 4: Documentation, Blog Post, and Full Suite Verification**
  ...
  Focused capability, taxonomy, and docs-sync tests pass. The full suite was run;
  remaining failures are sandbox-blocked legacy agent-store/identity tests that
  attempt writes under `/Users/nikhilsoman/.synlynk` or bind a loopback socket.
