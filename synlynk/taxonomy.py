...
COMMAND_TAXONOMY = [
    ...
    {"command": "pack", "governs_stage": "execute", "maturity_tier": 1, "prominence": "primary",
     "orientation_gateway": False, "audience": "human",
     "trigger_phrases": ["synthesize context pack", "generate task pack", "pack context"], "hook_event": None},
    {"command": "impact", "governs_stage": "execute", "maturity_tier": 1, "prominence": "primary",
     "orientation_gateway": False, "audience": "human",
     "trigger_phrases": ["calculate blast radius", "impact analysis", "symbol callers and callees", "check impact"], "hook_event": None},
    {"command": "mesh", "governs_stage": "open", "maturity_tier": 1, "prominence": "primary",
     "orientation_gateway": False, "audience": "human",
     "trigger_phrases": ["merge fleet graphs", "aggregate multi-repo mesh", "federated knowledge graph", "cross-repo edges"], "hook_event": None},
    {"command": "spike eval", "governs_stage": "sustain", "maturity_tier": 1, "prominence": "secondary",
     "orientation_gateway": False, "audience": "human",
     "trigger_phrases": ["run spike evaluation", "evaluate spike", "benchmark candidate", "spike receipt"], "hook_event": None},
    ...
    {"command": "heal", "governs_stage": "sustain", "maturity_tier": 2, "prominence": "primary",
     "orientation_gateway": False, "audience": "human", "trigger_phrases": ["fix repository gaps automatically", "run autonomous remediation", "run parity remediation", "remediate adoption parity", "heal parity", "detect circular dependencies", "heal import cycles", "circular import detector"], "hook_event": None},
    ...
    {"command": "backup create", "governs_stage": "sustain", "maturity_tier": 1, "prominence": "secondary",
     "orientation_gateway": False, "audience": "human",
     "trigger_phrases": ["create a state database backup", "snapshot state for disaster recovery"], "hook_event": None},
    {"command": "backup verify", "governs_stage": "sustain", "maturity_tier": 1, "prominence": "secondary",
     "orientation_gateway": False, "audience": "human",
     "trigger_phrases": ["verify a state database backup", "check a recovery snapshot"], "hook_event": None},
    {"command": "backup encrypt", "governs_stage": "sustain", "maturity_tier": 1, "prominence": "secondary",
     "orientation_gateway": False, "audience": "human",
     "trigger_phrases": ["encrypt state backup", "export encrypted state backup"], "hook_event": None},
    {"command": "backup package", "governs_stage": "sustain", "maturity_tier": 1, "prominence": "secondary",
     "orientation_gateway": False, "audience": "human",
     "trigger_phrases": ["package state for disaster recovery", "create an encrypted DR package"], "hook_event": None},
    {"command": "backup verify-encrypted", "governs_stage": "sustain", "maturity_tier": 1, "prominence": "secondary",
     "orientation_gateway": False, "audience": "human",
     "trigger_phrases": ["verify encrypted state backup", "test encrypted state restore"], "hook_event": None},
    {"command": "state inventory", "governs_stage": "sustain", "maturity_tier": 1, "prominence": "secondary",
     "orientation_gateway": False, "audience": "human",
     "trigger_phrases": ["inventory state databases", "audit state DB artifacts"], "hook_event": None},
    {"command": "state promote", "governs_stage": "sustain", "maturity_tier": 1, "prominence": "secondary",
     "orientation_gateway": False, "audience": "human",
     "trigger_phrases": ["promote a state database", "repair canonical state"], "hook_event": None},
    {"command": "state quarantine", "governs_stage": "sustain", "maturity_tier": 1, "prominence": "secondary",
     "orientation_gateway": False, "audience": "human",
     "trigger_phrases": ["quarantine a legacy state database", "isolate a state DB copy"], "hook_event": None},
    {"command": "state restore", "governs_stage": "sustain", "maturity_tier": 1, "prominence": "secondary",
     "orientation_gateway": False, "audience": "human",
     "trigger_phrases": ["restore state from DR snapshot", "recover canonical state DB"], "hook_event": None},
    {"command": "state register", "governs_stage": "sustain", "maturity_tier": 1, "prominence": "secondary",
     "orientation_gateway": False, "audience": "human",
     "trigger_phrases": ["register an existing state database", "repair a missing registry entry"], "hook_event": None},
    ...
    {"command": "story reclaim", "governs_stage": "goal", "maturity_tier": 1, "prominence": "secondary",
     "orientation_gateway": False, "audience": "human",
     "trigger_phrases": ["reclaim stranded stories", "unstrand abandoned stories"], "hook_event": None},
    ...
    {"command": "backlog ingest", "governs_stage": "open", "maturity_tier": 1, "prominence": "secondary",
     "orientation_gateway": False, "audience": "human",
     "trigger_phrases": ["ingest github issues", "fetch backlog issues"], "hook_event": None},
    {"command": "backlog triage", "governs_stage": "open", "maturity_tier": 1, "prominence": "primary",
     "orientation_gateway": False, "audience": "human",
     "trigger_phrases": ["triage open backlog", "synthesize backlog stories"], "hook_event": None},
    {"command": "backlog auto-promote", "governs_stage": "open", "maturity_tier": 1, "prominence": "secondary",
     "orientation_gateway": False, "audience": "human",
     "trigger_phrases": ["auto-promote backlog items", "promote triaged stories to ready"], "hook_event": None},
    ...
    {"command": "charters adapt", "governs_stage": "sustain", "maturity_tier": 2, "prominence": "secondary",
     "orientation_gateway": False, "audience": "human",
     "trigger_phrases": ["adapt living charters", "detect charter drift"], "hook_event": None},
    ...
    {"command": "governs sweep", "governs_stage": "sustain", "maturity_tier": 2, "prominence": "primary",
     "orientation_gateway": False, "audience": "human",
     "trigger_phrases": ["run the governs sweep", "reconcile governs stages", "backfill governs goals", "sweep governs"], "hook_event": None},
    ...
    {"command": "marketing ceremony", "governs_stage": "release", "maturity_tier": 2, "prominence": "secondary",
     "orientation_gateway": False, "audience": "human",
     "trigger_phrases": ["run marketing release ceremony", "synchronize release collateral"], "hook_event": None},
    {"command": "marketing sync-pr", "governs_stage": "release", "maturity_tier": 2, "prominence": "secondary",
     "orientation_gateway": False, "audience": "human",
     "trigger_phrases": ["sync pr blog post", "generate pr blog post", "marketing sync pr"], "hook_event": None},
    ...
    {"command": "quota advisory", "governs_stage": "sustain", "maturity_tier": 2, "prominence": "secondary",
     "orientation_gateway": False, "audience": "human",
     "trigger_phrases": ["fleet utilization advisory", "show quota advisory", "dynamic capacity advisory"], "hook_event": None},
    ...
    {"command": "whoami", "governs_stage": "open", "maturity_tier": 0, "prominence": "secondary",
     "orientation_gateway": False, "audience": "human",
     "trigger_phrases": ["who am I", "show active caller identity"], "hook_event": None},
    ...
    {"command": "run", "governs_stage": "execute", "maturity_tier": 2, "prominence": "primary",
     "orientation_gateway": False, "audience": "human",
     "trigger_phrases": ["run milestone dag", "execute milestone unattended", "launch milestone dag"],
     "hook_event": None},
    ...
    {"command": "relay broadcast", "governs_stage": "execute", "maturity_tier": "latent", "prominence": None,
     "orientation_gateway": False, "audience": "hook", "trigger_phrases": [], "hook_event": None},
    {"command": "relay status", "governs_stage": "visualize", "maturity_tier": 2, "prominence": "secondary",
     "orientation_gateway": False, "audience": "human", "trigger_phrases": ["check relay health"], "hook_event": None},
    {"command": "relay send", "governs_stage": "execute", "maturity_tier": 2, "prominence": "secondary",
     "orientation_gateway": False, "audience": "human", "trigger_phrases": ["message another agent"], "hook_event": None},
    {"command": "relay tail", "governs_stage": "visualize", "maturity_tier": 2, "prominence": "secondary",
     "orientation_gateway": False, "audience": "human", "trigger_phrases": ["tail relay events"], "hook_event": None},
    ...
    {"command": "identity list", "governs_stage": "sustain", "maturity_tier": "latent", "prominence": None,
     "orientation_gateway": False, "audience": "pilot", "trigger_phrases": [], "hook_event": None},
    {"command": "identity show", "governs_stage": "open", "maturity_tier": "latent", "prominence": None,
     "orientation_gateway": False, "audience": "pilot", "trigger_phrases": [], "hook_event": None},
    {"command": "identity whoami", "governs_stage": "open", "maturity_tier": "latent", "prominence": None,
     "orientation_gateway": False, "audience": "pilot", "trigger_phrases": [], "hook_event": None},
    {"command": "identity triplet", "governs_stage": "open", "maturity_tier": "latent", "prominence": None,
     "orientation_gateway": False, "audience": "pilot", "trigger_phrases": [], "hook_event": None},
    {"command": "relay peer list", "governs_stage": "sustain", "maturity_tier": "latent", "prominence": None,
     "orientation_gateway": False, "audience": "pilot", "trigger_phrases": [], "hook_event": None},
    {"command": "relay peer add", "governs_stage": "sustain", "maturity_tier": "latent", "prominence": None,
     "orientation_gateway": False, "audience": "pilot", "trigger_phrases": [], "hook_event": None},
