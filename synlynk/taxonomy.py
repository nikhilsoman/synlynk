...
COMMAND_TAXONOMY = [
    ...
    {"command": "heal", "governs_stage": "sustain", "maturity_tier": 2, "prominence": "primary",
     "orientation_gateway": False, "audience": "human", "trigger_phrases": ["fix repository gaps automatically", "run autonomous remediation", "run parity remediation", "remediate adoption parity", "heal parity"], "hook_event": None},
