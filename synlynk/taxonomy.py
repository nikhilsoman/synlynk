...
COMMAND_TAXONOMY = [
    ...
    {"command": "harness add", "governs_stage": "open", "maturity_tier": 0, "prominence": "secondary",
     "orientation_gateway": False, "audience": "human",
     "trigger_phrases": ["add this agent binary", "retrofit an agent onto this project"], "hook_event": None},
    {"command": "harness configure", "governs_stage": "open", "maturity_tier": 0, "prominence": "secondary",
     "orientation_gateway": False, "audience": "human",
     "trigger_phrases": ["write this agent's context profile"], "hook_event": None},
    {"command": "harness list", "governs_stage": "open", "maturity_tier": 0, "prominence": "secondary",
     "orientation_gateway": False, "audience": "human",
    ...
    {"command": "session open", "governs_stage": "sustain", "maturity_tier": 1, "prominence": "primary",
     "orientation_gateway": False, "audience": "human",
     "trigger_phrases": ["open a work session", "start a work session"], "hook_event": None},
    {"command": "session status", "governs_stage": "sustain", "maturity_tier": 1, "prominence": "primary",
     "orientation_gateway": False, "audience": "human",
     "trigger_phrases": ["what session am I in", "show the active session"], "hook_event": None},
    {"command": "session checkpoint", "governs_stage": "sustain", "maturity_tier": 1, "prominence": "secondary",
     "orientation_gateway": False, "audience": "human",
     "trigger_phrases": ["checkpoint this session", "save a session checkpoint"], "hook_event": None},
    {"command": "session close", "governs_stage": "sustain", "maturity_tier": 1, "prominence": "secondary",
     "orientation_gateway": False, "audience": "human",
     "trigger_phrases": ["close out this session", "finish this work session"], "hook_event": None},
    ...
    {"command": "backlog capture", "governs_stage": "open", "maturity_tier": 1, "prominence": "secondary",
     "orientation_gateway": False, "audience": "human",
     "trigger_phrases": ["capture discovered work", "stage a task into backlog"], "hook_event": None},
    {"command": "backlog list", "governs_stage": "open", "maturity_tier": 1, "prominence": "secondary",
     "orientation_gateway": False, "audience": "human",
     "trigger_phrases": ["list staged backlog", "show discovered tasks"], "hook_event": None},
    {"command": "backlog sync", "governs_stage": "open", "maturity_tier": 1, "prominence": "secondary",
     "orientation_gateway": False, "audience": "human",
     "trigger_phrases": ["sync backlog to github", "create issues for discovered tasks"], "hook_event": None},
    ...
    {"command": "policy check-merge", "governs_stage": "release", "maturity_tier": 2, "prominence": "secondary",
     "orientation_gateway": False, "audience": "human",
     "trigger_phrases": ["am I authorized to merge this", "check merge authority"], "hook_event": None},
    {"command": "policy show", "governs_stage": "sustain", "maturity_tier": 2, "prominence": "secondary",
     "orientation_gateway": False, "audience": "human",
     "trigger_phrases": ["show current policy", "what is the current policy"], "hook_event": None},
    ...
    {"command": "audit-docs", "governs_stage": "sustain", "maturity_tier": 2, "prominence": "secondary",
     "orientation_gateway": False, "audience": "human",
     "trigger_phrases": ["audit docs", "audit devlog identity drift", "audit documentation"], "hook_event": None},
    ...
    {"command": "exit", "governs_stage": "sustain", "maturity_tier": "latent", "prominence": None,
     "orientation_gateway": False, "audience": "pilot", "trigger_phrases": [], "hook_event": None},
    {"command": "harness run", "governs_stage": "execute", "maturity_tier": "latent", "prominence": None,
     "orientation_gateway": False, "audience": "pilot", "trigger_phrases": [], "hook_event": None},
