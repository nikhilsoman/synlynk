...
COMMAND_TAXONOMY = [
    ...
    {"command": "events tail", "governs_stage": "sustain", "maturity_tier": "latent", "prominence": None,
     "orientation_gateway": False, "audience": "pilot", "trigger_phrases": [], "hook_event": None},
    {"command": "backlog note", "governs_stage": "sustain", "maturity_tier": "latent", "prominence": None,
     "orientation_gateway": False, "audience": "pilot", "trigger_phrases": [], "hook_event": None},
    {"command": "backlog scan-session", "governs_stage": "sustain", "maturity_tier": "latent", "prominence": None,
     "orientation_gateway": False, "audience": "pilot", "trigger_phrases": [], "hook_event": None},
