...
merged: open
tags: posts
excerpt: "v0.4.1 extends synlynk's instruction injection from 3 CLI targets to 7 tracked files. Cursor, GitHub Copilot, and Windsurf now receive synlynk context. A SHA manifest and runtime drift detection complete the picture."
---
